...
// Before widget //
	...
	<a title="Follow <?php bloginfo('name') ?> on StumbleUpon" href="http://stumbleupon.com/<?php echo $twtid; ?>" target="_blank">
	...
	<a title="Follow <?php bloginfo('name') ?> on Digg" href="http://digg.com/<?php echo $twtid; ?>" target="_blank">
	...
	<a title="Follow <?php bloginfo('name') ?> on YouTube" href="http://youtube.com/<?php echo $twtid; ?>" target="_blank">
...
// Widget Control Panel //
 ...
 $defaults = array( 'title' => 'Socially!', 'fbid' => 'bhargavtejaa', 'twtid' => 'btejaa' );
